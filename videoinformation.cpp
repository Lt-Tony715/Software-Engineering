...
void VideoInformation::getVideoInfo(QString file_path){
    ...
    //qDebug()<<"format: "<<input_AVFormat_context_->streams[0]->codecpar->format<<endl;
    //qDebug()<<"bit rate: "<<input_AVFormat_context_->bit_rate/1000.0<<endl;
...
bool VideoInformation::pic_flag()
{
    return this->flagpic ;
}
